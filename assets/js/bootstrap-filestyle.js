...
(function ($) {
    ...
    Filestyle.prototype = {
        ...
        icon: function (value) {
            if (value === true) {
                ...
                if (this.options.icon) {
                    ...
                    this.$elementFilestyle.find('.icon-filestyle').remove();
                }
            } else {
        ...
        iconName: function (value) {
            if (value !== undefined) {
                this.$elementFilestyle.find('.icon-filestyle').attr({
        ...
        htmlIcon: function () {
            if (this.options.icon) {
                return '<span style="margin-right: 3px;" class="icon-filestyle ' + this.options.iconName + '"></span> ';
            } else {
                return '';
            }
        },
    ...
    $.fn.filestyle.defaults = {
        ...
        'iconName': 'icon-folder-open icon-large',
        'buttonName': 'btn-info',
        'size': 'nr',
        'input': true,
        'badge': true,
