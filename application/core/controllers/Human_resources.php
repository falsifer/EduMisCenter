...
class Human_resources extends CI_Controller {
    ...
    public function hr03_insert() {
        ...
        if ($id != '') {
            $arr = array(
                'prefix_id' => $this->input->post('inHr03Prefix'),
    ...
    public function hr04() {
        $hr_id = $this->uri->segment(2);
        $data['human'] = $this->My_model->get_where_row('tb_human_resources_01', array('id' => $hr_id));
        $data['rs'] = $this->My_model->get_all_order('tb_human_resources_04', 'hr04_year desc, hr04_month asc, hr04_day asc');
        $this->load->view('layout/header');
    ...
    public function hr07_add() {
        ...
        if ($id != '') {
            ...
            $arr = array(
                'hr07_begin_day' => $this->input->post('inHr07BeginDay'),
                'hr07_begin_month' => $this->input->post('inHr07BeginMonth'),
                'hr07_begin_year' => $this->input->post('inHr07BeginYear'),
                'hr07_end_day' => $this->input->post('inHr07EndDay'),
                'hr07_end_month' => $this->input->post('inHr07EndMonth'),
                'hr07_end_year' => $this->input->post('inHr07EndYear'),
                'hr07_topic' => $this->input->post('inHr07Topic'),
                'hr07_place' => $this->input->post('inHr07Place'),
                'hr07_long' => $this->input->post('inHr07Long'),
                'hr07_province' => $this->input->post('inHr07Province'),
