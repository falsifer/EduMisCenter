<div class="box">
    <div class="box-heading">  ข้อมูลผู้ใช้งานระบบ(<?php echo $this->session->userdata('department') ?>)
        ...
        <button type="button" onclick="ExportTemp(this)" class="btn btn-success btn-excel-export" style="float:right"><i class="icon-download-alt icon-large"></i> รูปแบบไฟล์ Excel (.xls)</button>
    </div>
    <ul class="breadcrumb">
    ...
    <div class='pull-right'>
        <?php
//        $data['AreaID'] = 'MemberBody';
//        $this->load->view('layout/my_school_print', $data);
//        ?> 
<!--        <script>
            window.onload = function () {
                $('#MySchoolAreaId').val("MemberBody");
            };
        </script>-->
    </div>
