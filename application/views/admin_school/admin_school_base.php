        ...
        <div class="box-body" style="padding:50px;">
            <div class="container-fluid" style="text-align: center;">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <a href="#" class="btn btn-link" onclick="javascript:location.href = '<?php echo site_url('insignia-information'); ?>';"><?php echo img('images/admin/insignia.png'); ?><?php echo br(2); ?><span style='font-size:1.2em;'>ประเภท<br/>เครื่องราชอิสริยาภรณ์</span></a>
                    </div>
<!--                    <div class="col-md-3">
