<div class="box">
    <div class="box-heading">บันทึกคะแนนกิจกรรมผู้เรียน</div>
    <ul class="breadcrumb">
        <li><?php echo anchor(site_url(), "<i class='icon-home icon-large'></i> หน้าแรก"); ?></li>
        <li><?php echo anchor('ed-activity', "กิจกรรมผู้เรียน"); ?></li>
        <li>บันทึกคะแนนกิจกรรมผู้เรียน</li>
    </ul>
    <div class="box-body" >
        <div class="row">
...
<!--                        <div class="col-md-2 form-group">
                        ...
                        <div class="row">
                            ...
                            <select name="inTbEdActivityScoreInsert" id="inTbEdActivityScoreInsert" class="my-select" required>
                                    <option value="">-เลือกข้อมูล-</option>
...
<script>
    $("#insert-form").on("submit", function (e) {
        ...
        $.ajax({
            url: "<?php echo site_url('ed-activity-insert-score'); ?>",
            method: "post",
