                ...
                <form id="insert-form" method="post" class="form-horizontal">
                    <div class="row" style="padding-top:30px;padding-bottom:30px;">
                        <div class="col-md-12 form-group">
                            ...
                            <div class="col-md-2">
                                <input type="number" name="inProcessSeq" id="inProcessSeq" class="form-control" required autofocus/>
                            </div>
                        </div>
                        <div class="col-md-12 form-group">
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <div class="col-md-4">
                                <div class="input-group">
                                    <input type="text" autocomplete="off" name="inProcessStart" id="inProcessStart" class="form-control datepicker" placeholder="คลิกวันที่..." data-date-format="yyyy-mm-dd" required/>
                            ...
                            <div class="col-md-4">
                                <div class="input-group">
                                    <input type="text" autocomplete="off" name="inProcessEnd" id="inProcessEnd" class="form-control datepicker" placeholder="คลิกวันที่..." data-date-format="yyyy-mm-dd" required/>
                                    <span class="input-group-addon"><i class="icon-calendar"></i></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 form-group">
                            ...
                            <div class="col-md-10">
                                ...
                                <section>
                                    <input class="magicsearch" name="inResponsibleTmp" id="inResponsibleTmp" placeholder="ค้นหาชื่อ สามารถใส่ได้หลายชื่อ...">
                                </section>
