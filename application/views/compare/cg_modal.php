<!-- Modal -->
<div id="cg-modal" class="modal fade" role="dialog">
                ...
                <form method="post" id="import-form" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-12  form-group">
                            ...
                            <input type="hidden" name="tableName" value="tb_router" />
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group">
                            <center><button type="submit" class="btn btn-success btn-insert3"><i class="icon-save icon-large"></i> บันทึกข้อมูล</button></center>
                        </div>
                    </div>
...
//    $("#import-form").on("submit", function (e) {
    $(".btn-insert3").on("click", function (e) {
        e.preventDefault();
        $.ajax({
