<div class="box">
    <div class="box-heading">เพิ่มข้อมูลเยี่ยมบ้านนักเรียน</div>
    <ul class="breadcrumb">
        <li><?php echo anchor(site_url(), "<i class='icon-home icon-large'></i> หน้าแรก"); ?></li>
        <li><?php echo anchor('vh-base', "งานเยี่ยมบ้านนักเรียน"); ?></li>
        <li>เพิ่มข้อมูลเยี่ยมบ้านนักเรียน</li>
    </ul>
    <div class="box-body" >
        <div class="row">
                ...
                <div class="col-md-12 ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 form-group">
                            ...
                            <input type="text" name="inStdNo" id="inBsS" class="form-control" autofocus />
                        </div>
                    </div>  
