                ...
                <div class='col-md-4'>
                    <div class='mycardcontent' style='height: 100%;width: 100%;margin-bottom: 20px;'>
                        ...
                        <button type='button' class='btn btn-primary My-btn' onclick='StudentBase()'>
                            <i class="icon-user icon-large"></i> สัมมะโนนักเรียน
                        </button>
                        <script>
                            function StudentBase() {
                                location.href = '<?php echo site_url('student-homeroom'); ?>?room_id=' + $('#inEdRoomId').val();
                            }
                        </script>
                        <br/>
...
<script>
    ...
    window.onload = function () {
        ...
        var optionsStdAb1 = {
            ...
            title: {
                text: "การมาเรียน วันที่ 10 มิถุนายน  2562",
                fontSize: 16,
                fontFamily: 'Sarabun'
            },
            data: [
            ...
            data: [
                {
                    ...
                    indexLabel: "{name} - {y} คน",
                    dataPoints: [
                        {y: 15, name: "เยี่ยมแล้ว"},
                        {y: 2, name: "ยังไม่ได้เยี่ยม"},
                    ]
                }
            ]
        };
