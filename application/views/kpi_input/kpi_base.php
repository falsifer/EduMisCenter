<div class="box">
    <div class="box-heading">การบันทึกคะแนนรายตัวชี้วัด</div>
    <ul class="breadcrumb">
        <li><?php echo anchor(site_url(), "<i class='icon-home icon-large'></i> หน้าแรก"); ?></li>
        <li><?php echo anchor('ed-evaluation', "งานวัดผลและประเมินผล"); ?></li>
        <li>การบันทึกคะแนนรายตัวชี้วัด</li>
    </ul>
    <div class="box-body">
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <form method="post" id="insert-form" enctype="multipart/form-data">
                    <div class="row">
                        <b>ข้อมูลการบันทึกคะแนนรายตัวชี้วัด</b>
                        <br></br>
                    </div>
                    <div class="row">
                        <div class="col-md-4 form-group">                            
                            <label class="control-label">เลือกระดับชั้น / วิชาที่จะบันทึกคะแนน</label>                            
                                ...
                                <tr>
                                    ...
                                    <?php foreach ($rs as $rr): ?>
                                        <td style="text-align:center;">
                                            <input type="text"  size="1" name="inCourseMidScore" id="inCourseMidScore" class="form-control" />
                                        </td>
                                    <?php endforeach; ?>
                                </tr>
                                <?php $row++; ?>
