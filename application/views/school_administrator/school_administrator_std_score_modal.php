    ...
    <div class="modal-dialog" style="width:90%;">
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding:30px;">
                ...
                <form method="post" id="std-adm-score-form" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 form-group">
                            <button type="submit" class="btn btn-success btn-insert" style='margin-top:25px;' onclick='InsertAdmTopic()'><i class="icon-save icon-large"></i> บันทึกข้อมูล</button>
                        </div>
                    </div>
