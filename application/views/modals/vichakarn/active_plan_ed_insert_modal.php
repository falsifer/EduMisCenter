    ...
    <div class="modal-dialog" role="document" style="width:1250px;">
        <div class="modal-content">
            <div class="modal-header" style="background:#ebebeb;">
                ...
                <h4 class="modal-title">บันทึกรายละเอียดแผนการศึกษาและปฏิทินปฏิบัติงานวิชาการ</h4>
            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text"  autocomplete="off" name="inActivityPlanStartDate" id="inActivityPlanStartDate" class="form-control datepicker" placeholder="คลิกวันที่..." data-date-format="yyyy-mm-dd" required/>
                                ...
                                <div class="col-md-3 form-group ">
                                    ...
                                    <div class="input-group">
                                        <input type="text"  autocomplete="off" name="inActivityPlanEndDate" id="inActivityPlanEndDate" class="form-control datepicker" placeholder="คลิกวันที่..." data-date-format="yyyy-mm-dd" required/>
                                        <span class="input-group-addon"><i class="icon-calendar"></i></span>
                                    </div>
...
$(".datepicker").datepicker({autoclose: true, language: 'th'});
    ...
    $("#plan-insert-form").on("click", ".btn-insert", function (e) {
        ...
        $.ajax({
            ...
            url: "<?php echo site_url('school/Vichakarn/activity_plan_add'); ?>",
            method: "post",
            data: $("#plan-insert-form").serialize(),
            success: function (data) {
                $("#plan-insert-form")[0].reset();

               // location.href = "<?php echo site_url('activity-planing'); ?>";
            }
