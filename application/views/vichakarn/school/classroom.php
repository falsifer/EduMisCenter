...
<script>
    ...
    if (status == "ผู้ปฏิบัติงาน" && res == 'งานธุรการ') {
    ...
    $("#example").on("click", ".btn-detail", function () {
        ...
        $.ajax({
            url: "'Vichakarn/school/classroom_detail'",
            method: "POST",
            data: {id: uid},
    ...
    $("#example").on("click", ".btn-edit", function () {
        var uid = $(this).attr('id');
        $.ajax({
            url: "<?php echo site_url('Vichakarn/school/classroom_edit'); ?>",
            method: "post",
            data: {id: uid},
            dataType: "json",
            success: function (data) {
    ...
    $('#example').on('click', '.btn-delete', function () {
        ...
        if (status) {
            $.ajax({
                url: '<?php echo site_url('Vichakarn/school/classroom_delete'); ?>',
                method: 'post',
                data: {id: uid},
                success: function (data) {
                    location.reload();
