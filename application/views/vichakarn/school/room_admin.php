<div class="box">
    ...
    <ul class="breadcrumb">
        ...
        <li><?php echo anchor(site_url('admin-school-base'), "<i class='icon-cog icon-large'></i> ส่วนการจัดการระบบ"); ?></li>
        <li><?php echo anchor(site_url('school-base'), "<i class='icon-cog icon-building'></i> ข้อมูลพื้นฐานโรงเรียน"); ?></li>
