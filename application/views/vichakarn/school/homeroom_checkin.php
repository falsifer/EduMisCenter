                ...
                <center>
                    <div class="row">
                        ...
                        <div class="col-md-12" style="margin: 5px 0px;">
                            ...
                            <input type="checkbox"  name="absent<?php $r['id']?>" id="checkin" value="มา" />&nbsp;มา
                            <input type="checkbox" name="absent<?php $r['id']?>" id="absent" value="ขาด" />&nbsp;ขาด
                            <input type="checkbox" name="absent<?php $r['id']?>" id="sick" value="ลาป่วย" />&nbsp;ลาป่วย
                            <input type="checkbox" name="absent<?php $r['id']?>" id="sick" value="ลากิจ" />&nbsp;ลากิจ
                        </div>
                         <div class="col-md-12" style="margin: 5px 0px;">
                             หมายเหตุ&nbsp;<textarea class="form-control"></textarea>
                         </div>
