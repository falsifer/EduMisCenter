<div class="box">
    ...
    <div class="box-body">
        <div class="row"> 
            <div class="col-md-3 tab-menu-active"><i class='icon-print'></i> ตารางสอน</div>
        ...
        <div class="row databox">
            <div class="row"> 
                <div class="col-md-6 tab-menu"><?php echo anchor(site_url('ed-schedule-report'), "<i class='icon-calendar'></i> ตารางสอนรายชั้น"); ?></div>
                <div class="col-md-6 tab-menu-active"><i class='icon-calendar'></i> ตารางสอนรายผู้สอน</div>
...
<script>
    ...
    function MyTermOnChange(e) {
        ...
        $.ajax({
                url: "<?php echo site_url('school/Schedule/list_section_by_user'); ?>",
                method: "post",
