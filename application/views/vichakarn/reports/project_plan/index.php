                ...
                <div class="databox" style="padding:0px;">
                    <div class="row" style="margin-top:0px;text-align:center;">
                        <div class="col-md-12" style="padding-left:0px;padding-right:0px;">
                            ...
                            <div  style="margin-bottom:5px;" class="btn btn-info btn-exam" onclick="javascript:location.href = '<?php echo site_url('provice-strategic-definetion'); ?>';"><i class="icon-list icon-large pull-left"></i><?php echo nbs(3); ?>แผนยุทธศาสตร์จังหวัด</div>
                            <div  style="margin-bottom:5px;" class="btn btn-info btn-exam" onclick="javascript:location.href = '<?php echo site_url('localgov-strategic-definetion'); ?>';"><i class="icon-list icon-large pull-left"></i><?php echo nbs(3); ?>แผนยุทธศาสตร์องค์การบริหารส่วนจังหวัด</div>
                            <div  style="margin-bottom:5px;" class="btn btn-info btn-exam" onclick="javascript:location.href = '<?php echo site_url('education-strategic-definetion'); ?>';"><i class="icon-list icon-large pull-left"></i><?php echo nbs(3); ?>แผนยุทธศาสตร์กอง/สำนักการศึกษา</div>
                            <div  style="margin-bottom:5px;"  class="btn btn-info btn-exam" onclick="javascript:location.href = '<?php echo site_url('school-strategic-definetion'); ?>';"><i class="icon-list icon-large pull-left"></i><?php echo nbs(3); ?>แผนยุทธศาสตร์<?php echo $this->session->userdata('department'); ?></div>
