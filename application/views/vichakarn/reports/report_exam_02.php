...
<div class="row" style="padding: 40px;font-family: 'THSarabunPsk'">                            
...
<div class="row"><center><img src="<?php echo base_url(); ?>images/krut.jpg" width="100"></center></div>
                        <div class="row"><center>
                                <h1 style="font-size: 36px;font-family: 'THSarabunPsk'">ใบรับรองผลการเรียน</h1>
</center></div>
<div style="width: 100%;">
<div style="margin:auto;width:85%;font-size: 28px;font-family: 'THSarabunPsk'">
    <div>
