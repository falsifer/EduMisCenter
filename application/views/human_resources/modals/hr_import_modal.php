                ...
                <form method="post" id="import-form" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-12  form-group">
                            ...
                            <input type="hidden" name="tableName" value="tb_human_resources_01" />
                            <input type="hidden" name="department" value="hr_department" />
                            <input type="hidden" name="recorder" value="hr_recorder" />
