    ...
    <div class="modal-dialog" style="width:80%;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" id="insert-local-st-form" class="form-horizontal">
                    <div class="row" style="padding-top:30px;padding-bottom:30px;">
                        <div class="form-group col-md-12">
                             <div class="col-md-2">
                            <label class="control-label">กลยุทธ์ที่</label>
                           
                                <input type="number" name="inSubLocalgovStNo" id="inSubLocalgovStNo" class="form-control" autofocus required />
                            </div>
                             <div class="col-md-9">
                            <label class="control-label">ชื่อกลยุทธ์</label>
                           
                                <input type="text" name="inSubLocalgovStName" id="inSubLocalgovStName" class="form-control" autofocus required />
                            </div>
                        </div>
                        <div class="form-group col-md-12">
                            <center>
...
<script>
    ...
    $("#insert-local-st-form").on("submit", function (e) {
        e.preventDefault();
        $.ajax({
            url: "<?php echo site_url('EducationPlan/localgov_strategies_insert'); ?>",
            method: "post",
            data: $("#insert-local-st-form").serialize(),
