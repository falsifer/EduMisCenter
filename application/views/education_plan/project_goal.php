<div class="panel panel-primary">
    <div class="panel-heading">  เป้าหมาย (ผลผลิตของโครงการ)</div>
    <ul class="breadcrumb">
...
<script>
    ...
    $("#example").on("click", ".btn-edit", function () {
        ...
        $.ajax({
            url: "<?php echo site_url('edit-project-goal'); ?>",
            method: "post",
            data: {id: uid},
            dataType: "json",
    ...
    $("#example").on("click", ".btn-delete", function () {
        ...
        if (status) {
            $.ajax({
                url: "<?php echo site_url('delete-project-goal'); ?>",
                method: "post",
                data: {id: uid},
                success: function (data) {
                    location.reload();
...
<?php $this->load->view("education_plan/modals/project_goal_modal"); ?>