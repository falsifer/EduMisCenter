<div class="box">
    <div class="box-heading">พันธกิจ</div>
    <ul class="breadcrumb">
    ...
    <div class="box-body">
        <div class="databox">
            <form method="post" id="mission-insert-form">
                <div class="row">
                    <div class="col-md-12">
                        <label class="control-label">เนื้อหา</label><span class="star">&#42;</span>
                        <textarea class='editor' name='inMissionContent' id="inMissionContent">
                            <?php echo $rs==null? '' :$rs['tb_mission_content']; ?>
                        </textarea>
                    </div>
                </div>
...
<script>
    ...
    $("#mission-insert-form").on("click", ".btn-clear", function () {
        $("#mission-insert-form")[0].reset();
    });

    $("#mission-insert-form").on("submit", function (e) {
        e.preventDefault();
        $('#inMissionContent').html( tinymce.get('inMissionContent').getContent() );
        
        $.ajax({
            url: "<?php echo site_url('EducationPlan/mission_add'); ?>",
            method: "post",
            data: $("#mission-insert-form").serialize(),
            success: function (data) {
                $("#mission-insert-form")[0].reset();
                location.href = "<?php echo site_url('mission/'); ?>";
            }
