        ...
        <div class="row">
            <div class="col-md-12">
                <form method="post" id="insert-form" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12" id="courseTabID">
                    <table class="table table-hover table-striped table-bordered display" id="DcTable">                        
                        <thead>
                            <tr>
                                ...
                                <th style="width:30%; text-align: center">จัดการ</th>
                            </tr>
                        </thead>
...
<!--used modal-->
<?php $this->load->view("dc/dc_course_credit_modal"); ?>
...
<?php $this->load->view("dc/dc_import_modal"); ?>
<script>
...
//------ Set page Filter
    ...
    function ReloadTable(){
        ...
        $text = "โครงสร้างหลักสูตรสถานศึกษา";
        ...
        load_datatable($tabName, $btExArr, $title, $colStr,null,50);
