            ...
            <table class="table table-hover table-striped table-bordered display" id="sdqTab">
                <thead>
                    <tr>
                        ...
                        <th class="no-sort">ด้านกลุ่มปัญหา</th>
                        <th class="no-sort">จัดกิจกรรมในการแก้ปัญหา</th>
                        <th class="no-sort">วัน/เดือน/ปี</th>
                        <th class="no-sort">วิธีการแก้ไขปัญหา</th>
                        <th class="no-sort">ผลการดำเนินการ</th>
                        <th class="no-sort">สรุปผลการช่วยเหลือ</th>
                        <th class="no-sort">ส่งต่อฝ่าย</th>
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">จัดกิจจกรมในชั้นเรียน</td>
                            ...
                            <td style="text-align: center;">แก้ไขไม่ได้</td>
                            <td style="text-align: center;">ฝ่ายปกครอง</td>
                            <td style="text-align: center;">นางประภาภรณ์ ประกิจจะนะ</td>
                            <?php if ($this->session->userdata("status") == "ผู้ปฏิบัติงาน"): ?>
                                <td style="text-align:center;">
                                    <button type="button" class="btn btn-info btn-show" id=""><i class="icon-plus icon-large"></i> บันทึกการช่วยเหลือและส่งต่อ</button>
                                </td>
                            <?php endif; ?>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">ยุติการช่วยเหลือ</td>
                            <td style="text-align: center;">นางประภาภรณ์ ประกิจจะนะ</td>
                            <?php if ($this->session->userdata("status") == "ผู้ปฏิบัติงาน"): ?>
                                <td style="text-align:center;">
                                    <button type="button" class="btn btn-info btn-show" id=""><i class="icon-plus icon-large"></i> บันทึกการช่วยเหลือและส่งต่อ</button>
...
<script>
    ...
    if (status == "ผู้ปฏิบัติงาน") {
        $("div#sdqTab_length.dataTables_length").append("&nbsp;&nbsp;<button type='button' class='btn btn-warning btn-print'><i class='icon-print icon-large'></i> พิมพ์รายงานการช่วยเหลือและส่งต่อ</button>");
    }
