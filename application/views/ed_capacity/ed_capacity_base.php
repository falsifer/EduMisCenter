            ...
            <table class="table table-hover table-striped table-bordered display" id="example">
                <thead>
                    <tr>
                        ...
                        <th class="no-sort">สมรรถนะผู้เรียน</th>
                ...
                <tbody>
                    ...
                    <?php foreach ($rs as $r): ?>
                        <tr>
                            ...
                            <td><button class="btn btn-link btn-detail" id="<?php echo $r['id']; ?>"><?php echo $r['tb_ed_capacity_content']; ?></button></td>
...
<script>
    ...
    if (status == "ผู้ปฏิบัติงาน") {
        $("div#example_length.dataTables_length").append("&nbsp;&nbsp;<button type='button' class='btn btn-default btn-insert1'><i class='icon-plus icon-large'></i> บันทึกสมรรถนะผู้เรียน</button>");
        $("div#example_length.dataTables_length").append("&nbsp;&nbsp;<button type='button' class='btn btn-default btn-insert2'><i class='icon-plus icon-large'></i> บันทึกรายละเอียดสมรรถนะผู้เรียน</button>");
    ...
    $(".btn-insert1").on("click", function () {
        location.href = "<?php echo site_url('ed-capacity-insert-view'); ?>";
    });
    $(".btn-insert2").on("click", function () {
        location.href = "<?php echo site_url('ed-capacity-insert-sub-view'); ?>";
    });
    $(".btn-insert3").on("click", function () {
        location.href = "<?php echo site_url('ed-capacity-insert-score-view'); ?>";
    });
