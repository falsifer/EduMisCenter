<!-- Modal -->
<div id="ed-capacity-edit-modal" class="modal fade" role="dialog">
                            ...
                            <form method="post" id="insert-form" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-10 form-group">
                                        <label class="control-label">รายละเอียดสมรรถนะผู้เรียน</label>
...
<script>
    $("#insert-form").on("submit", function (e) {
        ...
        $.ajax({
            url: "<?php echo site_url('ed-capacity-update'); ?>",
            method: "post",
