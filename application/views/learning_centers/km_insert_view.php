<div class="panel panel-primary">
    <div class="panel-heading">เพิ่มข้อมูลแหล่งเรียนรู้ภายในท้องถิ่น</div>
    <ul class="breadcrumb">
        <li><?php echo anchor(site_url(), "<i class='icon-home icon-large'></i> หน้าแรก"); ?></li>
        <li><a href="javascript:window.history.go(-1);">แหล่งเรียนรู้ภายในท้องถิ่น</a></li>
        <li>เพิ่มข้อมูลแหล่งเรียนรู้ภายในท้องถิ่น</li>
    </ul>
...
//                $("#insert-form")[0].reset();
//                location.reload();
location.href = "<?php echo ($this->session->userdata('department')!="กองการศึกษา" ||$this->session->userdata('department')!="สำนักการศึกษา" )?site_url('km-base'):site_url('km-base-zone'); ?>";
            }
        });
    });
</script>
