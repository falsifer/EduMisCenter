<div class="container-fluid">
    ...
    <div class="col-md-2">
        ...
        <div class="row" style="margin-top:8px;text-align:center;">
            <div class="col-md-12" style="padding-left:0px;padding-right:4px;">
                <button type="button" style="margin-bottom:5px;" class="btn btn-danger btn-submenu" onclick="javascript:location.href = '<?php echo site_url('km-base'); ?>';"><?php echo img("images/tourist.png"); ?> แหล่งเรียนรู้</button>
        ...
        <div class="row" style="margin-top:8px;text-align:center;">
            <div class="col-md-12" style="padding-left:0px;padding-right:4px;">
                <button type="button" style="margin-bottom:5px;"  class="btn btn-success btn-submenu"><?php echo img("images/money.png"); ?> จัดสรรงบประมาณ</button>
...
<?php $this->load->view("modals/vichakarn/active_plan_insert_modal.php");?>