        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="card-box table-responsive">
                  <font style="font-weight: bold;">แสดงผลทั้งหมด</font><br><br>
                  <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        $counter = 0;
                        $sum = 0;
                        $sql = "SELECT * from  tb_parcel_plan";
                        ...
                        foreach ($q as $key => $row) {
                         ...
                         <tr>
                           ...
                           <td>
                              ...
                              &nbsp; / &nbsp;
                              <a href="<?php echo site_url(); ?>delete_plan.php?id=<?php echo $tbl_order_pro_id; ?>"  title="Delete" onclick='javascript:confirmationDelete($(this));return false;'>ลบ</a>							
                      ...
                      <?php  
								   ...
								   $i++;} ?>  
                                   <tr>
                                       <td  colspan="7" align="center"><font style="font-weight: bold;">ยอดที่ขออนุมัติทั้งหมด</font></td>
            ...
            <div class="col-sm-6">
                <fieldset class="form-group">
                   ...
                   <select class="form-control" name="approval_plan">
                    <?php
                    $sql = "SELECT * from  tb_parcel_category";
                    $query = $this->db->query($sql);
                    $q = $query->result_array();
