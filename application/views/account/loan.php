    ...
    <div class="box-body">
        ...
        <div class="row">
            ...
            <div class="col-md-10 panel" style="padding: 10px;">
               <legend class="legend-heading">ข้อมูลเงินยืม</legend>
                            <div class="col-md-12 databox">
                                <form method="post" id="insert-fianance-form">
                                    <div class="row" style="padding: 5px;">
                                        ...
                                        <div class="col-md-6">
                                            <label>ประเภท</label>
                                            <?php echo nbs(3); ?><input class="magic-radio form-control" type="radio" name="inFinanceType"  value="Cash" id="cash" ><label for="cash">เงินสด</label>&nbsp;
                                            <input class="magic-radio form-control" type="radio" name="inFinanceType"  value="Bank" id="bank" checked><label for="bank">ธนาคาร</label>
                                        </div>
                                    </div>
                                    <div class="row" style="padding: 5px;">
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" name="inFinanceDate" id="inFinanceDate" />
                                            บาท
                                        </div>
                                    </div>
