...
<script>
    function ClearThisCourseDetail(e) {
        var status = confirm('ต้องการลบข้อมูลนี้จริงหรือไม่ ?');
        var uid = e.id;
        if (status) {
            $.ajax({
                url: "<?php echo site_url('Course_detail/clear_course_detail'); ?>",
                method: "post",
                data: {id: uid},
    ...
    function InsertCourseDetail(e) {
        var uid = e.id;
        $.ajax({
            url: "<?php echo site_url('Course_detail/insert_course_detail'); ?>",
            method: "post",
            data: {id: uid, class: $("#MyClass").val(), term: $("#MyTerm").val()},
            success: function (data) {
                FilterCourse();
            }
...
//        }
    ...
    function FilterCourse() {
        $.ajax({
            url: "<?php echo site_url('Course_detail/course_by_classid_term_edyear'); ?>",
            method: "post",
...
//    modal
    function unitclick(e) {
        ...
        $.ajax({
            url: "<?php echo site_url('Course_detail/get_unit_list'); ?>",
            method: "post",
            data: {id: uid},
            beforeSend: function () {
                MyStartLoading();
...
//        CourseId = e.id;
//        $.ajax({
//            url: "<?php echo site_url('Course_detail/get_course_purpose_list'); ?>",
//            method: "post",
//            data: {id: CourseId},
...
//        });
    ...
    function standardclick(e) {
        ...
        $.ajax({
            url: "<?php echo site_url('Course_detail/get_standard_unit'); ?>",
            method: "post",
    ...
    function resultclick(e) {
        ...
        $.ajax({
            url: "<?php echo site_url('Course_detail/get_result'); ?>",
            method: "post",
            data: {id: uid},
            beforeSend: function () {
                MyStartLoading();
    ...
    function DeleteThisCourse(e) {
        ...
        if (status) {
            $.ajax({
                url: '<?php echo site_url('Course_detail/delete_course_by_id'); ?>',
                method: 'post',
                data: {id: e.id},
                success: function (data) {
                    FilterCourse(e);
...
//    alert('NE !')
        $.ajax({
            url: "<?php echo site_url('Course_detail/edit_course_by_id'); ?>",
            method: "post",
            data: {id: e.id},
            dataType: "json",
            success: function (data) {
