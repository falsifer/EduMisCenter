<div id="arsenal-modal" class="modal fade" role="dialog">
...
<script>
    $("#insert-form").on("submit", function (e) {
        ...
        var file = $('#inTbArsenalDoc').val();
        var ext2 = $("#inTbArsenalDoc").val().split('.').pop().toLowerCase();
        ...
        if (file != "" && jQuery.inArray(ext2, ['pdf','xls','xlsx','doc','docx','rar']) == -1) {
            alert('ไฟล์เอกสารจะต้องเป็นชนิด pdf,xls,xlsx,doc,docx เท่านั้น');
            $(":file").filestyle('clear');
            return false;
        }
