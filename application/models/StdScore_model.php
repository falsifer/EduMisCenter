...
//        $CourseId = id record ของวิชา
        ...
        if (isset($MyQ1[0]['tb_std_course_final_score_score'])) {
...
//        print_r($this->get_weighting_score($midScore, $maxUnit_array, $unitScore_array));
        $result = $this->get_weighting_score($midScore, $maxUnit_array, $unitScore_array);
        return $result/($i+1);
    }
    ...
    public function get_std_by_sec($scId, $cid, $edyear) {
        ...
        $this->db->where('c.tb_course_id', $cid);
