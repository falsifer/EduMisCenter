...
//                $data['TaStat'] = $this->My_model
//                $data['TaStat'] = $this->My_model->count_record_where('tb_human_resources_01', array('hr_department' => $this->session->userdata('department'), 'hr_type_id' => '3'));
                $sql2 = "select count(*) as pnt from tb_human_resources_01 where hr_type_id='3' and hr_department ='" . $this->session->userdata('department') . "' 
   ";
                ...
                $data['TaStat'] = $query2->result()[0]->pnt;
                }else{
                    $data['TaStat'] = 0;
                }
...
group by a.tb_student_base_department";
                ...
                $data['StdStat'] = $query->result()[0]->pnt;
                }else{
                    $data['StdStat'] = 0;
                }
