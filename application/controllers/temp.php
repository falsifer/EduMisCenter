...
<div class="row">
    <div class="form-group col-md-3">
        ...
        <input type="text" name="inEvDocumentDate" id="inEvDocumentDate" class="form-control datepicker" data-date-format="yyyy-mm-dd" placeholder="คลิกวันที่..." required/>
    </div>
</div>



<?php if ($this->session->userdata("status") == "ผู้ปฏิบัติงาน" && $this->session->userdata('responsible') == 'งานกำกับติดตามและประเมินผล'): ?>
    <div class="btn-group">
        <button type="button" class="btn btn-warning btn-sm dropdown-toggle" data-toggle="dropdown">
            <i class="icon-cogs icon-large"></i> OPT <span class="caret"></span></button>
        <ul class="dropdown-menu pull-right" role="menu" style="margin-bottom:60px;">
            <li><a href="#" class="btn btn-link btn-hr-01" id="<?php echo $r['id']; ?>">ขั้นตอนการดำเนินงาน</a></li>
            <li><a href="<?php echo site_url('human-resources-part-02/' . $r['id']); ?>">รายละเอียดค่าใช้จ่าย</a></li>
            <li><a href="<?php echo site_url('human-resources-part-03/' . $r['id']); ?>">เอกสาร/ภาพประกอบ</a></li>
        </ul>
    </div>
...
<!-- td style -->
<td style="border:none;border-bottom:1px dashed #ccc;"></td>
                ...
                <tbody>
                    ...
                    <?php foreach ($rs as $r): ?>
                        <tr>
                            ...
                            <td><?php echo $r['supervison_task']; ?></td>
                            <?php if ($this->session->userdata("status") == "ผู้ปฏิบัติงาน"): ?>
...
<?php
$this->session->set_flashdata("message", "<div class='alert alert-danger'><span class='blink' style='color:green;font-weight:bold;display:block;margin-bottom:15px;'>บันทึกเรียบร้อย...</span><a class='close' data-dismiss='alert'><span style='font-size:13px;'>ปิดหน้าต่างนี้</span></a></div>");
$this->session->set_flashdata("message", "<div class='blink'>บันทึกเรียบร้อย...</div>");
?>
