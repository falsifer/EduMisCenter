...
$route['visitor-admin'] = 'Visitor/visitor_admin_page'; // หน้าผู้ดูแลระบบ
$route['visitor-human_resources'] = 'Visitor/hr_import';
$route['visitor-std-base'] = 'StudentImport/index';
$route['visitor-edoc'] = 'Visitor/edoc';
$route['visitor-qa'] = 'Qa/qa_report';
$route['visitor-human_resources'] = 'Human_resources/index';
$route['visitor-km-base']= "Learning_centers/km_base";
$route['visitor-hr-promote'] = 'Management/hr_give_up';
$route['visitor-hr-training']  = "Management/hr_development";
$route['visitor-supervision']  = "Supervision/index";
...
//// การจัดสรรงบประมาณ
$route['budget-plan'] = "BudgetPlan/index";
$route['budget-plan-list'] = "BudgetPlan/budget_plan_list";
...
// การจัดสรรงบประมาณให้โรงเรียนที่ร้องขอ
$route['loan-management-external'] = 'SchoolLoan/loan_ext';
$route['insert-loan-management-external'] = 'SchoolLoan/loan_ext_add';
$route['update-loan-management-external'] = 'SchoolLoan/loan_ext_edit';
$route['delete-loan-management-external'] = 'SchoolLoan/loan_ext_delete';
$route['print-loan-management-external'] = 'SchoolLoan/loan_ext_print';

// บันทึกรายการจ่ายงบประมาณ
$route['payment-loan-management-external/(:num)'] = 'SchoolLoan/loan_ext_payment/$1';
$route['insert-payment-external'] = 'SchoolLoan/loan_payment_add';
$route['update-payment-external'] = 'SchoolLoan/loan_payment_edit';
$route['delete-payment-external'] = 'SchoolLoan/loan_payment_delete';
$route['print-payment-external/(:num)'] = 'SchoolLoan/loan_payment_print/$1';

#------------------------------------------------------------------------------#
// กำหนดหมวดใช้สอย
$route['loan-category'] = 'SchoolLoan/loan_category';
$route['insert-loan-category'] = 'SchoolLoan/loan_category_add';
$route['update-loan-category'] = 'SchoolLoan/loan_category_edit';
$route['delete-loan-category'] = 'SchoolLoan/loan_category_delete';

// กำหนดประเภทค่าใช้สอย
$route['loan-type'] = 'SchoolLoan/loan_type';
$route['insert-loan-type'] = 'SchoolLoan/loan_type_add';
$route['update-loan-type'] = 'SchoolLoan/loan_type_edit';
$route['delete-loan-type'] = 'SchoolLoan/loan_type_delete';

// กำหนดรายการเงินโอน
$route['loan-define'] = 'SchoolLoan/loan_define';
$route['insert-loan-define'] = 'SchoolLoan/loan_define_add';
$route['update-loan-define'] = 'SchoolLoan/loan_define_edit';
$route['delete-loan-define'] = 'SchoolLoan/loan_define_delete';

// กำหนดงบประมาณตั้งไว้สำหรับแต่ละโรงเรียน
$route['loan-define-detail/(:num)'] = 'SchoolLoan/loan_define_detail/$1';
$route['insert-loan-define-detail'] = 'SchoolLoan/loan_define_detail_add';
$route['update-loan-define-detail'] = 'SchoolLoan/loan_define_detail_edit';
$route['delete-loan-define-detail'] = 'SchoolLoan/loan_define_detail_delete';
$route['print-loan-define-detail/(:num)'] = 'SchoolLoan/loan_define_detail_print/$1';

// การจัดสรรงบประมาณ
$route['school-loan'] = "SchoolLoan/index";

// รายละเอียดงบประมาณที่จัดสรร
$route['school-loan-detail/(:num)'] = 'SchoolLoan/school_loan_detail/$1';
$route['insert-school-loan-detail'] = 'SchoolLoan/school_loan_detail_add';
$route['update-school-loan-detail'] = 'SchoolLoan/school_loan_detail_edit';
$route['delete-school-loan-detail'] = 'SchoolLoan/school_loan_detail_delete';

// รายละเอียดการจัดสรรงบประมาณของแต่ละรายการ
$route['school-loan-detail-transfer/(:num)/(:num)'] = 'SchoolLoan/school_loan_detail_transfer/$1/$2';
$route['insert-loan-detail-transfer'] = 'SchoolLoan/loan_detail_transfer_add';
$route['update-loan-detail-transfer'] = 'SchoolLoan/loan_detail_transfer_edit';
$route['delete-loan-detail-transfer'] = 'SchoolLoan/loan_detail_transfer_delete';
$route['print-loan-detail-transfer/(:num)'] = 'SchoolLoan/loan_detail_transfer_print/$1';


// ดึงงบประมาณที่ตั้งไว้ไปแสดง
$route['get-loan-detail'] = 'SchoolLoan/get_loan_detail';

$route['loan-managment'] = 'SchoolLoan/sc_loan';
$route['insert-loan-managment'] = 'SchoolLoan/loan_add';
$route['update-loan-management'] = 'SchoolLoan/loan_edit';
$route['delete-loan-management'] = 'SchoolLoan/loan_delete';
...
// การจัดทำแผน
$route['budget'] = "BudgetPlan/budget";
$route['project-plan'] = "ProjectPlan/init_plan";
//$route['school-planing'] = "EducationPlan/school";
$route['school-planing/(:num)'] = "ProjectPlan/project_school/$1";
//$route['project-planing'] = "EducationPlan/project_planing";
$route['project-planing'] = "ProjectPlan/project_planing_personal";
...
# ----------------------------------------------------------------------------+
//
$route['km-base-zone'] = "Learning_centers/km_base_zone";
...
$route['school-qa-report-zone'] = 'Qa/qa_report_zone';
...
$route['operational-regulation-list'] = 'school/Vichakarn/op_regulation_list';
...
$route['asset'] = 'parcel/Asset/index';
$route['asset-report'] = 'parcel/Asset/report';
...
$route['depreciation'] = 'parcel/Articles/depreciate_base';
$route['purchase-project-list-all'] = 'parcel/Approve_purchase/get_purchase_list_for_approve';
...
//-----งานเยี่ยมบ้าน-----
$route['visit-home'] = 'Homeroom/visit_home_base';
...
$route['rec-report-md'] = 'Rec_report/rec_report_md';
...
$route['student-census'] = "Student_census/student_census_base";


$route['course-detail'] = "Course_detail/dc_base_setting"; 

$route['vehicle'] = "School_bus/vehicle";//จัดการรถ
$route['school-bus-management'] = "School_bus/manage";//จัดการนักเรียนขึึ้นรถ
$route['school-bus-list'] = "School_bus/school_bus_list";//หน้าหลัก
$route['school-bus'] = "School_bus/index";//บันทึกรับส่ง


$route['edutech-classroom-online'] = "Classroom_online/classroom_online_base";
$route['edutech-classroom-online-room'] = "Classroom_online/classroom_online_room_base";
$route['edutech-classroom-online-member'] = "Classroom_online/classroom_online_member_base";
$route['edutech-classroom-online-work'] = "Classroom_online/classroom_online_work_base";
$route['edutech-classroom-online-assignment'] = "Classroom_online/classroom_online_assignment_base";

$route['student-affairs'] = "Student_affairs/student_affairs_base";
$route['student-affairs-std-absent-record'] = "Student_affairs/student_affairs_std_absent_record_base";

//--------- REST API -------
$route['rest-login']= "RestAPI/check_login";
$route['rest-student-list']= "RestAPI/get_std_homeroom";
$route['rest-std-list-absent']= "RestAPI/get_std_homeroom_absent";
$route['rest-std-absent']="RestAPI/update_absent_record";
$route['rest-std-transfer']="RestAPI/get_std_list_by_vehicle";
$route['rest-taech-schedule']="RestAPI/get_schedule_by_teacher";
$route['rest-activity-plan']="RestAPI/get_activity_plan";
$route['rest-advertise']="RestAPI/get_advertise";
$route['rest-get-std']="RestAPI/get_student";
$route['rest-std-schedule']="RestAPI/get_schedule_by_std";
$route['rest-std-homework']="RestAPI/get_homework";
$route['rest-std-absent-stat']="RestAPI/get_std_absent_stat";
$route['rest-std-absent-all']="RestAPI/get_std_absent_all";
$route['rest-set-std-school-bus']="RestAPI/insert_student_school_bus";

$route['admin-school-division-base']="Admin_school/admin_school_division_base";


$route['bd-base-zone-view'] = "Zone_monitor/bd_base_zone_view";
$route['human_resources_development-zone-view'] = "Zone_monitor/hr07_zone_view";

$route['excellence-base'] = "Excellence/excellence_base";
$route['school-bank-student-base'] = "School_bank/school_bank_student_base";
$route['mobile-view-student-pp6'] = "Mobile/mobile_view_student_pp6";


$route['course-score-base'] = "StudentScore/course_score_base";
...
//--------Report---------
$route['ed-rw-analysis-report'] = "Report/rwa_report";
$route['activity-planing-insert-view'] = 'Eschool/activity_plan_insert_view';
$route['hr-homeroom-vh-calendar'] = "Homeroom/hr_homeroom_vh_calendar_base";

$route['student-affairs-school-bus'] = "Student_affairs/student_affairs_school_bus_base";


$route['teaching-task-course-work-base'] = "Teaching_task/teaching_task_course_work_base";
$route['pp5-fill-score'] = "Teaching_task/teaching_task_go_pp5_fill_score_base";

$route['teaching-task-result-base'] = "Teaching_task/teaching_task_result_base";

$route['enroll-register-form'] = "Outside/enroll_register_form_base";

$route['teaching-task-course-unit-base'] = "Teaching_task/teaching_task_course_unit_base";

$route['teaching-task-absent-record'] = "Teaching_task/teaching_task_absent_record";

$route['teaching-task-cha'] = "Teaching_task/teaching_task_cha";

$route['teaching-task-rwa'] = "Teaching_task/teaching_task_rwa";
$route['teaching-task-work-assignment-base'] = "Teaching_task/teaching_task_work_assignment_base";


$route['course-todolist'] = "Teaching_task/course_todolist_base";
$route['course-student-result-base'] = "Teaching_task/course_student_result_base";
$route['teaching-task-stat-print-base'] = "Teaching_task/teaching_task_stat_print_base";

//require_once( BASEPATH .'database/DB.php' );
//$db =& DB();
//$query = $db->get( 'tb_router' );m
//$result = $query->result();
//
//   foreach($result as $r)
//   {
